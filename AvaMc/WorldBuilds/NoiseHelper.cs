...
public sealed class NoiseHelper
{
     ...
     */
    public static float PerlinNoise1(float x, int px)
    {
        int ix0,
            ix1;
        float fx0,
     ...
     */
    public static float PerlinNoise2(float x, float y, int px, int py)
    {
        int ix0,
            iy0,
            ix1,
     ...
     */
    public static float PerlinNoise3(float x, float y, float z, int px, int py, int pz)
    {
        int ix0,
            iy0,
            ix1,
    ...
    public static float PerlinNoise4(
        float x,
        float y,
        float z,
        float w,
