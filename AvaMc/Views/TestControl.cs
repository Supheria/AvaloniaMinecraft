...
//
// public abstract class TestControl : OpenGlControlBase, ICustomHitTest
// {
//     public EventHandler<FrameInfo>? FrameInfoUpdated;
//     GL? Gl { get; set; }
//     protected CameraTest Camera { get; } = new();
//     protected float FovDegrees { get; private set; } = 45.0f;
//     protected float NearClipPlane { get; private set; } = 0.1f;
//     protected float FarClipPlane { get; private set; } = 1000.0f;
...
//         Camera.SetSize(Bounds.Size.ToVector2(), fovDegrees, nearClipPlane, farClipPlane);
//     }
//
